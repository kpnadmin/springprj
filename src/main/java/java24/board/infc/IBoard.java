...
public interface IBoard {
    ...
    ModelAttachFile getAttachFile();
    //

    ModelAttachFile getAttachFileList();
    //

    ModelAttachFile insertAttachFile();
    //

    ModelAttachFile deleteAttachFile();
    //

    ModelComments getComment();
    //
    
    ModelComments getCommentList();
    //
    
    ModelComments insertComment();
    //
    
    int updateComment();
    //
    
    ModelComments deleteComment();
    //
